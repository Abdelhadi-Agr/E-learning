...
public class prof_model {
	...
	public int insert_offre_in_DB(HttpServletRequest request) throws IOException
			{
				...
				String savePath = "C:\\Users\\hp\\eclipse-workspace\\E_learning\\src\\main\\webapp\\projet_V2\\assets\\img\\img_offre"+File.separator + fileName;
	...
	public boolean update_offre(HttpServletRequest request) {
		...
		image=request.getParameter("image");		
			...
			String savePath = "C:\\Users\\hp\\eclipse-workspace\\E_leaning\\src\\main\\webapp\\projet_V2\\assets\\img\\img_offre"+File.separator + fileName;
			try {
				part.write(savePath + File.separator);
			} catch (IOException e) {
				// TODO Auto-generated catch block
