   ...
   <jsp:include page="header_student.jsp"/>  
    ...
    <div class="header bg-secondary pb-3">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <h1 class="text-primary my-5 fs-1 text-center">Bienvenue ${student.name}!</h1>
    ...
    <section id="courses" class="courses">
      <div class="container"  data-aos="fade-up">
        <div class="section-title row pl-3 ml--5">
          <h2>Offres</h2>
          <p class="col-10 p-0">Dernier Offres</p>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row" data-aos="zoom-in" data-aos-delay="100">
                <c:if test = "${last_3_offres_size>=1}">
  					<c:forEach var="i" begin="0" end="2" step="1">
  					   <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                  		<div class="course-item">
                    		<img src="${last_3_offres[i].imageOffre}" class="img-offre" alt="...">
                    			<div class="course-content">
                      				<div class="d-flex justify-content-between align-items-center mb-3">
                        				<h4>${last_3_offres[i].matiere}</h4>
                        				<p class="price">${last_3_offres[i].prix} $</p>
                      				</div>
                      					<h3><a href="course-details.html"></a></h3>
                     					 <p>${last_3_offres[i].infos}.</p>
                     					 <p>${last_3_offres[i].email}</p>
                     					 <p>${last_3_offres[i].date}</p>
                      					<div class="trainer d-flex justify-content-between align-items-center">
                        				<div class="trainer-profile d-flex align-items-center">
                        				<form action="show_me_prof_profile" method="post">
                        				<input type="hidden" name="id_offre" value="${last_3_offres[i].id_offre}">
                          				<button type="submit" style="border:none;background-color:white;">
                          				<img src="${last_3_offres[i].img}" class="avatar avatar-sm rounded-circle mr-2" alt="">
                          				<span><small>${last_3_offres[i].name} ${last_3_offres[i].family_name}</small></span>
                          			    </button>
                          				</form>
                        				</div>
                        				<div class="trainer-rank d-flex align-items-center">
                          					<span class="mr-2">${last_3_offres[i].moyenne}</span><i class="far fa-star"></i>
                        				</div>
                      					</div>
                    			</div>
                    			<div class="card-footer bg-transparent border-success">
                    			<form action='contacter_prof' method='post'>
                      			<input type="hidden" name="contacter_prof_id_offre" value="${last_3_offres[i].id_offre}">
                    			...
                    			<div class="course-content">
                      				<div class="d-flex justify-content-between align-items-center mb-3">
                        				...
                        				<input type="hidden" name="id_offre" value="${last_3_offres[i].id_offre}">
                          				<button type="submit" style="border:none;background-color:white;">
                          				<img src="${last_3_offres[i].img}" class="avatar avatar-sm rounded-circle mr-2" alt="">
                          				<span>${last_3_offres[i].name} ${last_3_offres[i].family_name}</span>
                          			    </button>
                          				</form>
                        				</div>
                        				<div class="trainer-rank d-flex align-items-center">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
  					...
  					<c:forEach var="i" begin="0" end="2" step="1">
  						<div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            				<div class="member">
              				<img src="${random_3_profs[i].img}" class="img-offre" alt="">
              			<div class="member-content">
                			<h4>${random_3_profs[i].name} ${random_3_profs[i].family_name}</h4>
                			<span>${random_3_profs[i].email}</span>
                			<p>${random_3_profs[i].bio}</p>
                			<p>${random_3_profs[i].city}</p>
              			</div>
            			</div>
          				</div>
  					</c:forEach>
